...
font-size: 11px;
        ...
        <table class="tablex" style="padding-left:10px;padding-right:15px;width: 100%;">
            ...
            <tr style="text-align:center">
                <td class="tdx"><img src="./img/resta.png" alt="negativo"  style="height: 0.5cm; width:0.5cm;"></td>
                <td class="tdx"><img src="./img/resta.png" alt="negativo"  style="height: 0.5cm; width:0.5cm;"></td>
            ...
            <tr style="text-align:center">
                <td class="tdx"><img src="./img/suma.png" alt="positivo"  style="height: 0.5cm; width:0.5cm;"></td>
                <td class="tdx"><img src="./img/resta.png" alt="negativo"  style="height: 0.5cm; width:0.5cm;"></td>
